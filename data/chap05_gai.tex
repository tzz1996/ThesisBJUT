...
\begin{figure}[htb]
    ...
    \setlength{\belowcaptionskip}{-0.7cm}
    % 英文标题 %
    \caption*{Figure 5-3 Cross compile result}
\end{figure}
...
\begin{figure}[H]
    ...
    \setlength{\belowcaptionskip}{-0.7cm}
    % 英文标题 %
    \caption*{Figure 5-4 BMC firmware interface}
\end{figure}
...
\begin{figure}[H]
    ...
    \setlength{\belowcaptionskip}{-0.7cm}
    % 英文标题 %
    \caption*{Figure 5-5 Driver mesurement log}
\end{figure}
...
\begin{figure}[H]
    ...
    \setlength{\belowcaptionskip}{-0.7cm}
    % 英文标题 %
    \caption*{Figure 5-6 BMC command results}
\end{figure}
...
\begin{figure}[H]
    ...
    \setlength{\belowcaptionskip}{-0.7cm}
    % 英文标题 %
    \caption*{Figure 5-7 FD file dependency section content}
\end{figure}
...
\begin{figure}[H]
    ...
    \setlength{\belowcaptionskip}{-0.7cm}
    % 英文标题 %
    \caption*{Figure 5-8 Log information during driver loading}
\end{figure}
